...
const restaurants = [
  {
    name: "沐樂咖啡 Mu Le",
    lat: 25.0419, lng: 121.5338, distance: "約 350 m",
    rating: "4.1", bsLevel: "good",
    advice: "咖啡廳也能吃得穩——選沙拉或鹹食、避開甜點和含糖飲（拿鐵改無糖）。",
    dishes: ["沙拉/鹹食", "無糖咖啡", "避開甜點"],
    note: "忠孝新生 2 號出口，選對品項就友善。",
    breakdown: [
      { label: "餐後血糖反應", score: 4.0 },
      { label: "份量可控制", score: 4.2 },
      { label: "蔬菜/纖維量", score: 3.9 },
      { label: "精緻澱粉少", score: 3.8 },
    ],
    voices: [
      "「點沙拉＋無糖美式，邊工作邊吃也很穩。」— T2D 用戶",
      "「甜點和含糖拿鐵是地雷，忍住就好。」— 衛教師",
      "「離北科近、有插座，學生愛來。」— 北科貝友",
    ],
  },
  ...
  {
    name: "巧之味手工水餃",
    lat: 25.0448, lng: 121.5320, distance: "約 500 m",
    rating: "3.6", bsLevel: "ok",
    advice: "水餃皮是精緻澱粉——配酸辣湯（不勾芡）＋燙青菜，一次別叫太多顆。",
    dishes: ["10 顆內", "酸辣湯不勾芡", "加燙青菜"],
    note: "排隊名店、份量實在，關鍵在顆數和湯品。",
    breakdown: [
      { label: "餐後血糖反應", score: 3.4 },
      { label: "份量可控制", score: 3.8 },
      { label: "蔬菜/纖維量", score: 3.0 },
      { label: "精緻澱粉少", score: 2.8 },
    ],
    voices: [
      "「我固定 10 顆配酸辣湯，餐後還算平。」— T2D 用戶",
      "「沾醬別加太多糖醋醬。」— 衛教師",
      "「總統御用名號不是喊假的，但要控顆數。」— 北科貝友",
    ],
  },
  {
    name: "濟南牛肉麵",
    lat: 25.0408, lng: 121.5322, distance: "約 600 m",
    rating: "3.4", bsLevel: "ok",
    advice: "麵是精緻澱粉、湯偏高鈉——麵點小碗或留一半、多吃牛肉（蛋白質）、湯別喝完。",
    dishes: ["麵減半", "多吃牛肉", "湯別喝完"],
    note: "排隊名店，牛筋牛肉蛋白質足，澱粉自己收。",
    breakdown: [
      { label: "餐後血糖反應", score: 3.3 },
      { label: "份量可控制", score: 3.5 },
      { label: "蔬菜/纖維量", score: 2.6 },
      { label: "精緻澱粉少", score: 2.7 },
    ],
    voices: [
      "「牛肉吃好吃滿、麵留一半，餐後沒爆。」— T2D 用戶",
      "「湯很香但鈉高，別整碗喝乾。」— 衛教師",
      "「排隊也值得，記得控麵量。」— 北科貝友",
    ],
  },
  {
    name: "銀記手擀刀切牛肉麵",
    lat: 25.0449, lng: 121.5347, distance: "約 400 m",
    rating: "3.0", bsLevel: "care",
    advice: "大份量刀切麵＋免費紅茶奶茶喝到飽＝雙重糖陷阱。飲料改喝水、麵直接點小份或留一半。",
    dishes: ["麵點小份", "飲料改喝水", "多吃牛肉"],
    note: "光華老店、份量大，免費含糖飲是最大地雷。",
    breakdown: [
      { label: "餐後血糖反應", score: 2.5 },
      { label: "份量可控制", score: 2.8 },
      { label: "蔬菜/纖維量", score: 2.4 },
      { label: "精緻澱粉少", score: 2.2 },
    ],
    voices: [
      "「免費紅茶超甜，我都改喝自己的水。」— T2D 用戶",
      "「麵份量大，建議直接請店家給小份。」— 衛教師",
      "「便宜大碗適合餓爆的時候，但要忍飲料。」— 北科貝友",
    ],
  },
];
